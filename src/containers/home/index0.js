    ...
    return (<View style={{flex:1}}>
      ...
      */
      ...
      onChangeTab={e=>{
        ...
        // console.log('-------');
        // if (this.state.postsLists[e.i]) {
          // this.state.currentTabPostsList = this.state.postsLists[e.i];
          // console.log(this.state.currentTabPostsList);
        // } else {
          // this.state.currentTabPostsList = null;
        // }
      }}

      renderTabBar={() => <TabBar
        underlineColor="#292524"
        underlineHeight={2}
        activeTabTextStyle="red"
        tabBarStyle={{
          // marginTop:0,
          paddingTop:10,
          marginTop:0,
        ...
        // renderTab={()=><View><Text>123123</Text></View>}
      />}
      >
