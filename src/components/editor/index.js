...
import {
  StyleSheet, Text, View, Button, Image, ImagePickerIOS, TouchableOpacity,
  TouchableHighlight, ActivityIndicator, WebView, Platform,
...
export default class Editor extends Component {
  ...
  addPhoto = (type) => {
    ...
    const self = this;
    const fn = type == 'camera' ? ImagePicker.openCamera : ImagePicker.openPicker;
    const { me } = this.props;
