...
class Me extends React.Component {
  ...
  static navigationOptions = {
    ...
    tabBarIcon: ({ tintColor, focused }) => (<Image
      source={focused ? require('./images/me-active.png') : require('./images/me.png')}
      ...
      <ScrollView style={styles.container}>
          ...
          <View>
            ...
            */}
            ...
            <TouchableOpacity
              onPress={()=>{
                self.props.navigation.navigate('PeopleDetail', { title: me.nickname, id: me._id });
              }}
              style={styles.profile}
              >
              <View>
                <Text style={styles.nickname}>{me.nickname}</Text>
                <Text>{me.fans_count} 粉丝  {me.follow_people_count} 关注</Text>
              </View>
            ...
            {/* <View style={{marginTop:20, marginBottom: 30, alignItems:'center'}}>
              <Text>{me.follow_people_count} 关注     {me.fans_count} 粉丝     {me.follow_topic_count} 话题</Text>
            </View> */}
            
            {/* 
            <View style={styles.birf}>
              <Text>
                {me.birf ?
                  <Text style={styles.black}>{me.birf}</Text> :
                  <Text style={{color:'#999',lineHeight: 24, textAlign:'center'}}>介绍一下自己，可以让其他人快速的了解你。我们鼓励介绍你的职业、技能、博客、作品等...</Text>}
              </Text>
            </View>
            */}
            ...
            */}
            ...
            {/* 
              ...
              */}
              ...
              <TouchableOpacity onPress={()=>{
                this.props.navigation.navigate('UserInfoSettings');
              }}>
                <ListItem name={"个人资料"} />
              </TouchableOpacity>
            ...
            */}
              ...
              {/* https://itunes.apple.com/cn/app/id1261181004?action=write-review */}
