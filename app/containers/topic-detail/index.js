...
@connect(
  (state, props) => {
    ...
    return {
      topicList: getTopicListById(state, id),
      me: getProfile(state)
    }
  },
  dispatch => ({
            ...
            <PostsList
              ...
              renderHeader={<View style={styles.topicContainer}>
                ...
                <View style={{flex:1}}>
                  ...
                  <View><Text style={styles.brief}>{topic.brief}</Text></View>
                  <View style={{marginTop:5}}>
                    <Text style={{fontSize:13,color:'rgb(112, 112, 112)'}}>
                      {topic.posts_count} 帖子 {topic.follow_count} 关注
                    </Text>
                  </View>
                </View>
